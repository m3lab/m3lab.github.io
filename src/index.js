...
const imgFileName = 'lam_plate.vti';
const numFiles = 9;
const fileNames = ['matrix_full.vtp']; // vtk would not open!
for (let i = 1; i < numFiles; i++)
{
    fileNames.push('fibers_polylines_' + i.toString() + '.vtk');
